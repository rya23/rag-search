...
description: Use this when creating logic and while writing backend code (Python). These linting rules are of utmost importance and must be strictly followed.
---
...
Never add comments in your code
