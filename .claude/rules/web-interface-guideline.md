...
description: Concise rules for building accessible, fast, and delightful frontend UIs. When writing UI logic, interactions, or frontend code (JavaScript, JSX, HTML, CSS), use MUST / SHOULD / NEVER to guide decisions.
---
